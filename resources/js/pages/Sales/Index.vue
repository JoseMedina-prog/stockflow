...
const applyFilters = () => {
    router.get(route('sales.index'), { search: searchInput.value || undefined }, { preserveScroll: true, preserveState: true });
};
...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-4 p-4">
            <PageHeader title="Ventas" description="Registra y consulta las ventas de la tienda.">
                <template #actions>
                    <Button as-child>
            ...
            <div class="rounded-xl border border-border/60">
                ...
                />
                <EmptyState v-else :icon="Search" title="Sin resultados" description="No encontramos ventas con ese criterio." />
            </div>
